    ...
    class MouseClass {
      ...
      update() {
        if (this.takeoverActive) {
          const t = (performance.now() - this.takeoverStartTime) / (takeoverDuration * 1000)
          if (t >= 1) {
        ...
        if (this.isAutoActive && !this.takeoverActive) this.diff.multiplyScalar(autoIntensity)
      }
    }
...
`
    ...
    class Advection extends ShaderPass {
      ...
      constructor(simProps: any) {
        ...
        this.uniforms = (this as any).props.material.uniforms
        this.init()
      }
      init() {
        super.init()
    ...
    class ExternalForce extends ShaderPass {
      mouse!: THREE.Mesh
      private _simProps: any
      constructor(simProps: any) {
        super({ output: simProps.dst })
        this._simProps = simProps
        this.init()
      }
      setSimProps(simProps: any) {
        this._simProps = simProps
      }
      init() {
        super.init()
        const simProps = this._simProps
    ...
    class Viscous extends ShaderPass {
      ...
      private _viscous: any = 0
      private _iterations: any = 0
      private _dt: any = 0
      setArgs({ viscous, iterations, dt }: any) {
        this._viscous = viscous
        this._iterations = iterations
        this._dt = dt
      }
      update() {
        const viscous = this._viscous
        ...
        for (let i = 0; i < iterations; i++) {
          if (i % 2 === 0) {
            fbo_in = (this as any).props.output0
            fbo_out = (this as any).props.output1
          } else {
            fbo_in = (this as any).props.output1
            fbo_out = (this as any).props.output0
          }
          this.uniforms.velocity_new.value = fbo_in.texture
          ;(this as any).props.output = fbo_out
          this.uniforms.dt.value = dt
          super.update()
        }
        return fbo_out
    ...
    class Poisson extends ShaderPass {
      ...
      update() {
        ...
        for (let i = 0; i < iterations; i++) {
          if (i % 2 === 0) {
            p_in = (this as any).props.output0
            p_out = (this as any).props.output1
          } else {
            p_in = (this as any).props.output1
            p_out = (this as any).props.output0
          }
          this.uniforms.pressure.value = p_in.texture
          ;(this as any).props.output = p_out
          super.update()
        }
        return p_out
      }
    ...
    class Pressure extends ShaderPass {
      ...
      private _vel: any = null
      private _pressure: any = null
      setArgs({ vel, pressure }: any) {
        this._vel = vel
    ...
    class Simulation {
      ...
      update() {
        ...
        this.divergence.setArgs({ vel })
        this.divergence.update()
        this.poisson.setArgs({
          iterations: this.options.iterations_poisson
        })
        const pressure = this.poisson.update()
        this.pressure.setArgs({ vel, pressure })
    ...
    class WebGLManager {
      ...
      init() {
        this.props.$wrapper.prepend((Common.renderer as THREE.WebGLRenderer).domElement)
